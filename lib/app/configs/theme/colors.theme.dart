...
class ColorsTheme {
  ...
  /// Azul índigo — cor primária.
  static const Color primaryColor = Color.fromRGBO(99, 102, 241, 1);

  /// Preto escuro — fundo geral.
  static const Color backgroundColorDark = Color.fromRGBO(12, 12, 12, 1);

  /// Preto escuro — fundo geral.
  static const Color backgroundColorLight= Color.fromRGBO(233, 233, 233, 1);

  /// Roxo violeta — cor secundária, para destaques.
  static const Color secondaryColor = Color.fromRGBO(139, 92, 246, 1);

  /// Cinza muito escuro — superfícies no modo escuro.
  static const Color veryDarkGray = Color.fromRGBO(26, 26, 26, 1);
